    ...
    <div class="container px-4 py-5" id="icon-grid">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
            ...
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">紅白-一般母蝦</h3>
                    <div style="background-image: url('img/510371.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$120/隻<br>尺寸：1.2cm以上</p><p>一般級，母成蝦/新成母</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">紅白-一般仔蝦</h3>
                    <div style="background-image: url('img/紅白仔蝦.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$25/隻<br>尺寸：0.8~1.2cm</p><p>各種表現皆有，(紅白)顏色一般。隨機出貨，恕無法指定公母</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">紅白-殼偏白仔蝦</h3>
                    <div style="background-image: url('img/厚殼仔蝦1.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$35/隻<br>尺寸：0.8~1.2cm</p><p>因白色顯色較強，白色較飽滿，通常以白軀與花頭居多，喜歡較白的蝦的蝦友可以選擇這個</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">紅白-一般公蝦</h3>
                    <div style="background-image: url('img/公蝦2.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$50/隻<br>尺寸：1.2cm以上</p><p>適合做繁殖組公蝦</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">紅白-淘汰公蝦</h3>
                    <div style="background-image: url('img/淘汰公蝦2.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$20/隻<br>尺寸：1.2cm以上</p><p>適合做為開缸試水蝦、練功蝦</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">黑白-一般仔蝦</h3>
                    <div style="background-image: url('img/黑白_小.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$25/隻<br>尺寸：0.8~1.2cm</p><p>各種表現皆有，顏色一般。隨機出貨，恕無法指定公母</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">藍金剛-一般母蝦</h3>
                    <div style="background-image: url('img/藍金剛母蝦2.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$80/隻<br>尺寸：1.2cm以上</p><p>淡淡的天藍色十分療癒</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">藍金剛-一般仔蝦</h3>
                    <div style="background-image: url('img/藍金剛仔蝦.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$35/隻<br>尺寸：0.8~1.2cm</p><p>一般級，各種表現皆有，隨機出貨，恕無法指定公母</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#shrimp1"></use></svg>
                <div>
                    <h3 class="fw-bold mb-0 fs-4">黑金剛-一般仔蝦</h3>
                    <div style="background-image: url('img/黑金剛1.jpg');background-size: cover;"><img src="img/border.png" alt="水晶蝦" width="100%"></div>
                    <p>售價：$35/隻<br>尺寸：0.8~1.2cm</p><p>一般級，各種表現皆有，隨機出貨，恕無法指定公母</p>
                </div>
            </div>
