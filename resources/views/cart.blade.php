                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    ...
                                    <small class="text-muted">{{ $order->product->price }} x {{ $order->quantity }}</small>
                                </div>
                                <span class="text-muted">$ {{ $order->product->price * $order->quantity }}</span>
                            </li>
                            @endforeach
                        ...
                        <form class="card p-2">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-secondary">優惠碼</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <form class="needs-validation" novalidate="">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="username" placeholder="輸入聯絡人姓名" required="">
                            ...
                            <div class="mb-3">
                                <label for="email">Line <span class="text-muted">(選填)</span></label>
                                <input type="email" class="form-control" id="line" placeholder="輸入你的Line ID方便我們可以與你聯繫">
                            </div>

                            <div class="row city-selector-set">
                                <div class="col-md-5 mb-3">
                                    <label for="country">縣市</label>
                                    <select class="county custom-select d-block w-100"></select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="state">區</label>
                                    <select class="district custom-select d-block w-100"></select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" placeholder="xxx街xxx號" required="">
                            </div>

                            <hr class="mb-4">
                            <button class="btn btn-primary btn-lg btn-block" type="submit">送出訂單</button>
                        </form>
                    </div>
                </div>
            </div>
